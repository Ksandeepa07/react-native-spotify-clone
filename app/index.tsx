    ...
    <View>
      ...
      {Object.entries(dimensions).map(([key, value]) => (
        ...
        <View key={key} style={{ width, height, backgroundColor: '#191414', display: 'flex', alignItems: 'center'}}>
          ...
          <Pressable onPress={()=>router.push('LoginScreen')} style={styles.signUpBtn} >
          ...
          <Button onPress={()=>router.push('HomeScreen')} title="Login" titleStyle={styles.btnTxt} buttonStyle={styles.signUpWithBtn} />
